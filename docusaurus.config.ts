    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/decipher-zkvm/zkvm-docs/tree/main',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/decipher-zkvm/zkvm-docs',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'X',
              href: 'https://x.com/DecipherGlobal',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/decipher-zkvm',
            },
          ],
        },
      ],
